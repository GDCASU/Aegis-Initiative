...
public class VNSceneManager : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (SceneManager.GetActiveScene().name != "Intro")
        {
            ...
            else
            {
                ...
                if (profileManager.CurrentProfile.currentStage <4 ) SceneManager.LoadScene(GameManager.singleton.levels[profileManager.CurrentProfile.currentStage]);
                else LevelChanger.singleton.FadeOutToLevel("LevelSelect");
            }
        }
    }
    ...
    public void EndVNScene()
    {
        ...
        if (ProfileManager.instance.CurrentProfile.currentStage < 4) LevelChanger.singleton.FadeOutToLevel("CopilotUI");
        else LevelChanger.singleton.FadeOutToLevel("LevelSelect");
    }
}
